...
Внутренний инструмент для фиксации выполненных работ на строительном объекте. Прораб вносит записи о выполненных работах: дата, вид работ, объём с единицей измерения, исполнитель. Записи можно фильтровать по виду работ, сортировать по дате, добавлять, редактировать и удалять.
